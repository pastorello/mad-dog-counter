...
| 3 | [FUNCTIONAL_SPEC.md](FUNCTIONAL_SPEC.md) | Comportamento: zone di tap, incremento/decremento, subentro al vecchio counter, pannello impostazioni | Prima di implementare una feature |
